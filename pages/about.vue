<template>
  ...
  >
    ...
    <section class="md:w-106 mx-auto w-80 mt-12 lg:mt-0">
      <h1 class="text-5xl md:text-7.5xl text-dark-gray">about.</h1>
      <p class="text-white ff-monaco mt-8">
        Hi there, I'm Maclean. I'm a Software Engineer and a certified Scrum
        Master by trade, and a doer by heart. <br />
        <br />
        I love to play with different technologies and processes in order to
        find the best fit for each solution. This has led me to gain valuable
        ...
        and expertise in Software Development Processes such as Waterfall and
        Agile, I serve as a servant leader to my team. <br />
        <br />
        When I'm not doing any of the above, you'll find me passionately
        debating about football or playing video games. <br />
        Do well to get in touch with me on any of my Social Media handles for
        business, coffee, anything about Real Madrid and/or FIFA Esports.
      </p>
      ...
      >
        <div ref="linkedinIconRef" class="socialMediaIcon">
          <a
            href="http://linkedin.com/in/josephmacleanarhin"
            target="_blank"
